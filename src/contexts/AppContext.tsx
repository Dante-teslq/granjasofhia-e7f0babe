...
const vendaAllowed = new Set(["/estoque", "/evidencias", "/vendas-diarias", "/transferencias"]);
const depositoAllowed = new Set(["/estoque", "/evidencias", "/transferencias"]);
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
  ...
  const canAccess = (page: string) => {
    ...
    if (currentRole === "Supervisor") return page !== "/antifraude" && page !== "/integracoes" && page !== "/pontos-de-venda";
    if (currentRole === "Auditor") return page !== "/configuracoes" && page !== "/usuarios" && page !== "/antifraude" && page !== "/integracoes" && page !== "/pontos-de-venda";
